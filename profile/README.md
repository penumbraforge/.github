...
**[penumbraforge.com](https://penumbraforge.com)** — Developer and security tools with browser, edge, direct-network, and selectable AI routes labelled on each page. There's also a machine-readable index and an MCP server for deterministic functions. No accounts; check a tool's disclosure before entering sensitive data.
